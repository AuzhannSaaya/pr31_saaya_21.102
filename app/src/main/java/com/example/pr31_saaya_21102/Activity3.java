package com.example.pr31_saaya_21102;
...
public class MainActivity3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btngpt = findViewById(R.id.buttonGpt);
        btngpt.setOnClickListener((View.OnClickListener) MainActivity3.this);
